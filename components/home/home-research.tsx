  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#0a1218]">
      ...
      >
        ...
        >
          <Reveal as="h2" className="font-display text-[1.5rem] font-semibold leading-[1.15] text-[#fcfcfe] sm:whitespace-nowrap sm:text-[1.75rem] lg:text-[2rem] xl:text-[2.15rem]">
            {title}
          </Reveal>
