    ...
    <section className="bg-[#151514]">
      <SiteShell className="py-12 sm:py-14 lg:py-16 xl:py-20 min-[2560px]:py-24">
        <SiteContent>
          ...
          <Stagger
            className="mt-8 grid grid-cols-1 gap-7 sm:mt-10 sm:grid-cols-2 lg:mt-12 lg:grid-cols-4"
            stagger={0.08}
          >
            {stages.map((stage) => (
              <StaggerItem
          ...
          <div className="mt-10 grid gap-10 lg:mt-14 lg:grid-cols-2 lg:gap-12 xl:gap-16">
            ...
            <div>
              ...
              <Reveal className="rounded-[12px] bg-[#151514] px-5 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
          ...
          <div className="mt-10 lg:mt-14">
            <Reveal className="mb-5 flex items-center gap-3 lg:mb-6">
              <LaunchIcon className="size-7 text-[#fcfcfe] lg:size-8" />
              <h3 className="font-sans text-xl font-semibold text-[#fcfcfe] lg:text-[28px]">
                {designedFor.title}
              </h3>
          ...
          <Reveal className="mt-10 flex flex-col gap-5 rounded-lg border-2 border-[#92ac00] bg-transparent px-5 py-5 sm:mt-12 sm:px-6 lg:gap-6 lg:px-7 lg:py-6">
