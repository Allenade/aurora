    ...
    <section className="bg-[#fcfcfe]">
      <SiteShell className="py-12 sm:py-14 lg:py-16 xl:py-20 min-[2560px]:py-24">
        <SiteContent>
          ...
          <Reveal className="mt-8 overflow-hidden rounded-lg border border-[#757575]/40 bg-[#151514] px-5 py-5 sm:mt-10 sm:px-6 sm:py-6 lg:mt-12 lg:px-7 lg:py-7">
          ...
          <div className="mt-10 lg:mt-14">
            ...
            <Reveal className="rounded-xl bg-[#151514] px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
          ...
          <div className="mt-12 lg:mt-16">
            ...
            <Stagger
              className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:mt-8 lg:grid-cols-3 lg:gap-5"
              stagger={0.1}
            >
